...
db.define_table('simulation',
                ...
                Field('algorithm_id',db.algorithm),
                Field('job_id',db.job),
                Field('result_id',db.numeric_results))

db.define_table('simulation_algorithm_parameters',
                Field('simulation_id',db.simulation),
                Field('algorithm_parameter_id',db.algorithm_parameters),
                Field('algorithm_parameter_value','string'))
...
db.simulation_algorithm_parameters.simulation_id.requires = [IS_IN_DB(db, db.simulation.id),IS_NOT_EMPTY()]
db.simulation_algorithm_parameters.algorithm_parameter_value.requires = IS_NOT_EMPTY()
...
db.simulation.algorithm_id.requires = [IS_IN_DB(db,db.algorithm.id, '%(name)s'),IS_NOT_EMPTY()]
